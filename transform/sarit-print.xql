...
import module namespace fo="http://www.tei-c.org/tei-simple/xquery/functions/fo" at "xmldb:exist://embedded-eXist-server/db/apps/tei-publisher-lib/content/fo-functions.xql";

import module namespace ext-fo="http://www.tei-c.org/tei-simple/xquery/ext-fo" at "xmldb:exist://embedded-eXist-server/db/apps/tei-publisher-lib/content/../modules/ext-fo.xql";
                            ...
                            if (parent::lg) then
                                ...
                                if (parent::list) then
                                    ...
                                    if (preceding-sibling::head) then
                                        fo:omit($config, ., ("tei-head5"), .)
                                    else
                                        if (not(preceding-sibling::head)) then
                                            fo:heading($config, ., ("tei-head6"), (node(), for $h in ./following-sibling::head return (" - ", $h/node())))
                                        else
                                            if (parent::div) then
                                                fo:heading($config, ., ("tei-head7"), .)
                                            else
                                                fo:block($config, ., ("tei-head8"), .)
