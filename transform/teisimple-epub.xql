(:~
    ...
    ODD: /db/apps/sarit-pm/resources/odd/compiled/teisimple.odd
 :)
xquery version "3.1";

module namespace model="http://www.tei-c.org/tei-simple/models/teisimple.odd/epub";
...
import module namespace html="http://www.tei-c.org/tei-simple/xquery/functions" at "xmldb:exist://embedded-eXist-server/db/apps/tei-publisher-lib/content/html-functions.xql";

import module namespace epub="http://www.tei-c.org/tei-simple/xquery/functions/epub" at "xmldb:exist://embedded-eXist-server/db/apps/tei-publisher-lib/content/ext-epub.xql";
